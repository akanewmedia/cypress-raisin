...
import * as specificData from '../../../../data/Pledge/MultiPledgeFreeRegCoverAdminFee.json'
...
describe('C10524 - Registration > Cover Admin Fee > Free Reg + Self Donation + Store Item : ', function () {
