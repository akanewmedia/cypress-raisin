...
// -Apply Promo Code to make paid reg item free
// -Make Self Donation
// -Purchase Store Item
...
import * as specificData from '../../../../data/Pledge/MultiPledgePaidRegCoverAdminFeePromoToFreeReg.json'
...
describe('C10525 - Registration > Cover Admin Fee > Paid Reg with Promo Code to make Free Reg + Self Donation + Store Item : ', function () {
