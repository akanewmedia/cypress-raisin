...
// -Make Self Donation
// -Purchase Store Item
// -Select Cover Admin Fee (% amount is less than max)
// -Apply Promo Code to make reg item free
...
import * as specificData from '../../../../data/Pledge/MultiPledgePaidRegCoverAdminFeeUnderMax.json'
...
describe('C10529 - Registration > Cover Admin Fee > Paid Reg + Self Donation + Store Item > Percentage under max : ', function () {
