...
import * as specificData from '../../../data/Pledge/MultiPledgeStoreFailPurchaseOnly.json'
...
/* use event 16574 */
describe('TR(3016) Scenario -> Multi Pledge registration, volunteer - purchase only - failure', () => {
    using(events, event => {
        describe(`${event}`, () => {
            before(() => {
