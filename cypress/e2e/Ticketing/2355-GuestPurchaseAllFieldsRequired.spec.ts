...
import * as specificData from '../../data/Ticketing/GuestPurchaseAllFieldsRequired.json'
...
describe('TR(2355) Scenario -> Guest Purchase With All Fields Mandatory : ', () => {
	using(events, event => {
		describe(`${event}`, () => {
			...
			it('should enter the participant details', () => {
				...
				yourInformationPO.verifyFieldPresence();
				yourInformationPO.fillInAllFields(data);
				flowPO.continue();
			});
			...
			it('Edit the Billing Information Section', () => {
