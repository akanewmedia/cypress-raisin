...
export class UserProfile {
  ...
  verifyPersonalInfoRequiredFieldErrors(data) {
    ...
    cy.get(this.personalInfo + ' .mat-form-field-subscript-wrapper .error-message').should('exist').then(getTexts).should('deep.equal', data)
  }
  ...
  verifyAdditionalInfoRequiredFieldErrors(data) {
    ...
    cy.get(this.additionalInfo + ' .mat-form-field-subscript-wrapper .error-message').should('exist').then(getTexts).should('deep.equal', data)
  }
