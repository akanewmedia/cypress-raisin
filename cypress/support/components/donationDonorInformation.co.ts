...
export class DonationDonorInformation {
    ...
    constructor() {
        ...
        this.dateOfBirthDatePicker = this.profileContainer.$('#date-of-birth + mat-datepicker');
        this.corporateDonation = this.profileContainer.$('#contact-type').$('mat-checkbox');
        this.addressType = elementById('addressType', this.addressContainer);
        this.issueTaxReceipt = elementById('IssueTaxReceipt');
        this.optOut = this.additionalContainer.$('#optOut').$('mat-checkbox');
        this.optOutToShare = this.additionalContainer.$('#optOutToShare').$('mat-checkbox');
